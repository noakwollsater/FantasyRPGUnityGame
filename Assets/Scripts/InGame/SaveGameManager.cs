...
namespace Unity.FantasyKingdom
{
    public class SaveGameManager : MonoBehaviour
    {
        ...
        private void Start()
        {
            getActiveParts = FindAnyObjectByType<GetActiveParts>();
            getActiveColors = FindAnyObjectByType<GetActiveColors>();
            if (getActiveParts == null)
            {
                Debug.LogError("❌ GetActiveParts component is missing!");
            }
            if (getActiveColors == null)
            {
                Debug.LogError("❌ GetActiveColors component is missing!");
            }
        }
